...
TeslaLogger is a self hosted data logger for your Tesla Model S/3/X/Y/Cybertruck and [Lucid AIR](TeslaLogger/docs/en/lucid-install.md). Currently it supports RaspberryPi 3B, 3B+, 4B, Docker and Synology NAS.
