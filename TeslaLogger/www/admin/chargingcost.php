...
<tr><td><?php t("kWh according to meter/invoice"); ?>:</td><td><input id="cost_kwh_meter_invoice" size="4" tabindex="2"></span></td></tr>
<tr><td><?php t("Cost per kWh"); ?>:</td><td><input id="cost_per_kwh" size="4" tabindex="3"></span></td><td> * <span id="kwh_charged"></span> kWh</td><td class="sum"><span id="cost_per_kwh_sum"></span></td></tr>
<tr><td><?php t("Cost per charge"); ?>:</td><td><input id="cost_per_session" size="4" tabindex="4"></span></td><td></td><td class="sum"><span id="cost_per_session_sum"></span></td></tr>
<tr><td><?php t("Cost per minute"); ?>:</td><td><input id="cost_per_minute" size="4" tabindex="5"></span></td><td> * <span id="minutes_charged"></span> Minutes</td><td class="sum"><span id="cost_per_minute_sum"></span></td></tr>
<tr><td><?php t("Idle cost per minute"); ?>:</td><td><input id="cost_idle_fee_total" size="4" tabindex="6"></span></td><td></td><td class="sum"><span id="cost_idle_fee_total_sum"></span></td></tr>
